...
function FormCreateUser(props) {
  ...
  const handleSubmit = (e) => {
    ...
    fetch(`https://us-central1.gcp.data.mongodb-api.com/app/benavente-jinwz/endpoint/createUsuario?idInt=${`P`+Number(conteoId+1)}&puntos=${form.puntos}&role=${form.role}&nivelReward=${form.nivelReward}&fRegistro=${form.fRegistro}&esTutor=${form.esTutor}&tipoSangre=${form.tipoSangre}&nombre=${form.nombre}&aPaterno=${form.aPaterno}&aMaterno=${form.aMaterno}&tel1=${form.tel1}&tel2=${form.tel2}&idFamilia=${form.idFamilia}&observaciones=${form.observaciones}&rfc=${form.rfc}&username=${form.username}&password=${form.password}&fNacimiento=${form.fNacimiento}`,
        {method: "POST"})
      .then(res=>res.json())
          ...
          <form className='card' action="" id='add-user-form' onSubmit={handleSubmit} onReset={() => {
            ...
            <div className="row card-body">
              ...
              <div className="col-6 mb-3">
                ...
                <input type="tel" className="form-control form-control-sm" required maxLength={10} onChange={handleTel1} />
              </div>
              <div className="col-6 mb-3">
                <label htmlFor="">Tel 2</label>
                <input type="tel" className="form-control form-control-sm" maxLength={10} onChange={handleTel2} />
              </div>
              <div className="col-6 mb-3 ">
              ...
              {form.esTutor ?
                ...
                <div className="col-6 mb3">
                  <label htmlFor="">ID Familia</label>
                  <select name="" id="select-familia" className="form-select form-select-sm" onChange={handleFamiliaInput}>
              ...
              <div className="col-12 mb-3">
                ...
                <textarea className='form-control' placeholder='Alergias, condiciones existentes, si se está medicando...' required onChange={handleObservaciones}></textarea>
              </div>
              ...
              <div className="col-12 mb-3">
                ...
                <input type="text" className="form-control form-control-sm" minLength={11} maxLength={13} onChange={handleRFC} />
              </div>
              <div className="col-12 mb-3">
              ...
              <div className="col-12 mb-3">
                ...
                <input type="password" className="form-control form-control-sm" required onChange={handlePassword} />
